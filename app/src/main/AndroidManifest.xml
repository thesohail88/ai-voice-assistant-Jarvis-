...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <!-- Audio, Recording & Foreground Service Permissions -->
    ...
    <!-- Lock Screen, Wake & System Overlay -->
    ...
    <application
        ...
        <!-- Dynamic Sensor & Power Broadcast Receiver -->
        <receiver
            android:name=".SystemContextTriggerReceiver"
            android:enabled="true"
            android:exported="false">
            <intent-filter>
        ...
        <!-- Bluetooth / Earbud Button Trigger Receiver -->
        <receiver
            android:name=".MediaButtonTriggerReceiver"
            android:exported="true">
            <intent-filter>
